...
def test_transform_sparse_adaptive_pca():
    ...
    # I think you would be able to recover the previous tests of PC approx= PC
...
def test_marcenkopastur_thresholding_exact():
    """ We can test Marcenko-Pastur threshold out to 4 decimal places
        with the table defined in
...
def test_marcenkopastur_thresholding_approximate():
    """ We can test Marcenko-Pastur threshold out to 2 decimal places
        using the approximation defined in
        "The Optimal Hard Threshold for Singular Values is 4/sqrt(3)"(2014)
        Matan Gavish, David L. Donoho
        https://arxiv.org/abs/1305.5870" """
